...
github:
  ...
  collaboration: Community Projects
...
```diff
+ 📝 NoteApp-K — Android note-taking application.
+ ⚖️ Weight Log App — Android application for tracking weight and fitness progress.
+ 🌐 Weight Log Website — Web-based platform for monitoring weight-loss journeys.
+ 📦 Digital Complaint Box — Student complaint management and reporting system.
+ 🤝 Open Source Contributions — Bug fixes, UI improvements, and feature implementations.
```
